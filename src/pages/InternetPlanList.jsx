...
import styles from "../styles/InternetPlanList.module.css";
...
const InternetPlanList = () => {
    ...
    return (
        <div className={styles["interp-plan-container"]}>
            <div className={styles["interp-plan-title"]}>인터넷 요금제</div>
            <div className={styles["interp-plan-list"]}>
            ...
            {loading && <p className={styles["interp-plan-loading"]}>불러오는 중...</p>}
        </div>
    );
};
